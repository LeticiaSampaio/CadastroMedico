...
<div id="body_wrapper">
    <form class="div_form">
        ...
        <input type="password" id="senha_antiga" name="senha_antiga" class="input_form" placeholder="Insira a senha antiga">
        <label for="nova_senha" class="label_form">Nova senha</label>
        <input type="password" id="nova_senha" name="nova_senha" class="input_form" placeholder="Escolha uma nova senha forte e segura">
